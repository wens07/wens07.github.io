...
## git stash
```bash
# stash changes that not added to the index
git stash --keep-index  // which whill left the staged changes

# stash changes 
git stash

# apply the top stash[specific stash] and pop off the stash
